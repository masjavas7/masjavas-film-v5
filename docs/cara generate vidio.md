...
> [!NOTE]
> GrokPI `grok-imagine-1.0-video` mungkin belum support native image-to-video references. Jika belum, kita tetap mengirimkan prompt text yang menyebutkan reference secara detail. Reference images tetap digunakan untuk prompt building — tidak diabaikan.
